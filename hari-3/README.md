...
`
TxHash Deploy = https://sepolia.etherscan.io/tx/0x2a7f6cf5a59dbc35a12465f443e2542cffabf81f0b9fe8f98221887fa4e5d5b8

Tokenku Address = 0x7b2f5233f979556dea08f01caef5c72bbf34d37c
...
[ ] Buka interface pakai LIVE SERVER (JANGAN dobel-klik file HTML): 1. Install extension "Live Server" by Ritwick Dey di VSCode (sekali aja). 2. Di VSCode: File -> Open Folder -> pilih folder app/. 3. Klik kanan index.html -> "Open with Live Server",
ATAU klik tombol "Go Live" di pojok kanan-bawah VSCode. 4. Browser kebuka otomatis (mis. http://127.0.0.1:5500).
